...
struct uvmline uvmline[] = {
	...
	{ &uvmexp.wiredmax, &last_uvmexp.wiredmax, "wiredmax",
	  &uvmexp.vc_cpuid, &last_uvmexp.vc_cpuid, "vc_cpuid",
	  &uvmexp.flt_anon, &last_uvmexp.flt_anon, "flt_anon" },
	{ NULL, NULL, NULL,
	  &uvmexp.vc_wrmsr, &last_uvmexp.vc_wrmsr, "vc_wrmsr",
	  &uvmexp.flt_acow, &last_uvmexp.flt_acow, "flt_acow" },
	{ NULL, NULL, NULL,
	  &uvmexp.vc_rdmsr, &last_uvmexp.vc_rdmsr, "vc_rdmsr",
	  &uvmexp.flt_obj, &last_uvmexp.flt_obj, "flt_obj" },
	{ NULL, NULL, NULL,
	  &uvmexp.vc_ioio, &last_uvmexp.vc_ioio, "vc_ioio",
